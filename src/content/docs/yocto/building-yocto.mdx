...
$ mkdir <release>
$ cd <release>
$ repo init -u https://gitlab.com/mrs-neuralplex/yocto/manifest.git -b <branch name>
$ repo sync
```
...
$ mkdir scarthgap
$ cd scarthgap
$ repo init -u https://gitlab.com/mrs-neuralplex/yocto/manifest.git -b scarthgap
$ repo sync
```

#### Setup the build folder for a BSP release
By default, the NeuralPlex image selects the `imx8qm-np` machine, and `np-imx-wayland` backend.  If you wish to build for a different machine or backend, you may change this here.
...
<backend>   defaults to `np-imx-wayland`
