...
2. Setup Qt development environment by downloading the [latest version of Qt](https://www.qt.io/download). At the time of writing this document, the NeuralPlex has Qt 6.5.x installed. Navigate to [this link](https://www.youtube.com/watch?v=Y1jS9U1BiC0) to find the steps to install Qt6 in Ubuntu.
