...
At a minimum, to run the reference application, you will need to connect `KL30`, `KL15`, `GND`, `CAN0_L`, and `CAN0_R`.
...
1. Search for a network with SSID: `NeuralPlex-xxx`. The last section of the name will be unique stringfor each device.
